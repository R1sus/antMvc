...
;(function ($) {
  ...
  $.fn.waterwheelCarousel.defaults = {
    ...
    horizon:                    130,   // how "far in" the horizontal/vertical horizon should be set from the container wall. 0 for auto
    flankingItems:              6,   // the number of items visible on either side of the center                  
